...
docker pull gcr.io/hsl-gcp-prd-app-buzzwk-prj-spk/flexydial-app
...
sleep 3
docker tag gcr.io/hsl-gcp-prd-app-buzzwk-prj-spk/flexydial-app vedakatta/flexydial-app:latest 
